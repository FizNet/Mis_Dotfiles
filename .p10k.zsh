# Generated by Powerlevel10k configuration wizard on 2022-02-20 at 16:13 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$purple
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=$green
  ...
  function my_git_formatter() {
    ...
    local       meta="%F{$white}" # white foreground
    local      clean="%F{$black}" # black foreground
    local   modified="%F{$black}" # black foreground
    local  untracked="%F{$black}" # black foreground
